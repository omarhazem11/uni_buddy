...
class TermsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _LegalPage(title: 'Terms of Service', lastUpdated: 'July 2025', sections: _termsSections);
}
...
class PrivacyPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      _LegalPage(title: 'Privacy Policy', lastUpdated: 'July 2025', sections: _privacySections);
}
